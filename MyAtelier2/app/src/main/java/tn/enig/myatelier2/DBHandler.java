...
public class DBHandler extends SQLiteOpenHelper {
    ...
    // below variable id for our contact tel  column.
    private static final String TEl_COL = "tel";

    // below variable for our contact email column.
    ...
    public void addNewContact(String contactName, String contactTel, String contactEmail) {
    ...
    public ArrayList<ContactModal> readCourses()
    {
        ...
        if (cursorCourses.moveToFirst()) {
            do {
                ...
                courseModalArrayList.add(new ContactModal(
